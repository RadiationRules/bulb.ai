        ...
        <Tabs defaultValue="appearance" className="w-full">
          ...
          <TabsContent value="integrations" className="space-y-6">
            <Card className="overflow-hidden">
              <div className="bg-gradient-to-r from-[#24292e] to-[#1a1e22] p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-white flex items-center gap-2">
                      GitHub Integration
                      {githubConnected && (
                        <span className="inline-flex items-center gap-1 text-xs font-semibold px-2 py-0.5 rounded-full bg-green-500/20 text-green-400 border border-green-500/40">
              ...
              <div className="p-6 space-y-4">
                ...
                <p className="text-xs text-muted-foreground text-center">
                  Enables repository creation, automatic deployments, and GitHub Pages hosting
                </p>
              </div>
            </Card>
